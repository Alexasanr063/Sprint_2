...
# Не знаю как сделать правельнее я сделал этот вариант через список закоменчиный и основной незакоменчиный
# teams = [Football(2, 2, 2), Hockey(2, 2, 2)]
#
# for teams in teams:
#     print(teams.number_of_wins())
#     print(teams.number_of_draws())
#     print(teams.number_of_losses())
